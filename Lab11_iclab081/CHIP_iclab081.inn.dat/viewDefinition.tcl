...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/Img_input_B_BC.lib\
    ${::IMEX::libVar}/mmmc/Img_input_G_BC.lib\
    ${::IMEX::libVar}/mmmc/Img_input_R_BC.lib\
    ${::IMEX::libVar}/mmmc/process_temp_1_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/lib/typ/Img_input_B_WC.lib\
    ${::IMEX::libVar}/lib/typ/Img_input_G_WC.lib\
    ${::IMEX::libVar}/lib/typ/Img_input_R_WC.lib\
    ${::IMEX::libVar}/lib/typ/process_temp_1_WC.lib]\
   -si\
