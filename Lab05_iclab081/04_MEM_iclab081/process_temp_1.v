...
module process_temp_1 (A0,A1,A2,A3,A4,A5,A6,A7,DO0,DO1,DO2,DO3,DO4,DO5,
                       DO6,DO7,DI0,DI1,DI2,DI3,DI4,DI5,DI6,DI7,CK,WEB,
                       OE, CS);
...
`protect
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA  = (131:188:306);
      specparam TWDV = (99:141:230);
      specparam TRC  = (174:246:396);
      specparam THPW = (25:36:59);
      specparam TLPW = (25:36:59);
      specparam TAS  = (45:67:112);
      specparam TAH  = (10:11:16);
      specparam TWS  = (28:42:71);
      specparam TWH  = (10:10:10);
      specparam TDS  = (37:58:102);
      specparam TDH  = (10:10:10);
      specparam TCSS = (57:83:140);
      specparam TCSH = (9:14:23);
      specparam TOE      = (26:39:65);
      specparam TOZ      = (37:51:79);
